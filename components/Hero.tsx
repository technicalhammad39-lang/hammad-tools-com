...
const Hero = () => {
  return (
    <section className="relative min-h-[100dvh] md:min-h-[60dvh] md:max-h-[700px] lg:min-h-[100dvh] lg:max-h-none flex flex-col items-center justify-center pt-24 lg:pt-32 overflow-hidden w-full">
      {/* Background Layer */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-8xl font-black leading-[1.1] md:leading-[1] mb-8 text-brand-text flex flex-col items-start md:items-center lg:items-start gap-2 md:gap-4 text-left md:text-center lg:text-left transition-all">
              ...
              <span style={{ fontFamily: 'var(--font-display)' }} className="text-6xl sm:text-8xl md:text-9xl lg:text-9xl font-bold bg-gradient-to-b from-[#FFEA00] to-[#FF9500] bg-clip-text text-transparent uppercase leading-none mt-1 sm:mt-2 md:mt-0 whitespace-nowrap">
                <Typewriter
                  options={{
            ...
            <motion.p 
              ...
              className="text-base md:text-2xl text-gray-400 md:text-brand-text/60 mt-6 md:mt-10 mb-10 max-w-lg md:max-w-3xl leading-relaxed font-medium relative z-20 text-left md:text-center lg:text-left mx-0 md:mx-auto lg:mx-0"
            >
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-start md:justify-center lg:justify-start w-full md:w-auto">
              <Link href="/services" className="w-full md:w-auto">
                ...
                >
                  <span className="text-sm md:text-xl whitespace-nowrap">Explore Services</span>
            ...
            <div className="mt-6 md:mt-12 flex flex-row items-center justify-start md:justify-center lg:justify-start gap-4 sm:gap-8 text-left md:text-center lg:text-left">
              <div className="flex -space-x-5 md:-space-x-8">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-14 h-14 md:w-20 md:h-20 rounded-full border-2 border-brand-bg overflow-hidden shadow-xl relative first:ml-0">
                    <Image 
              ...
              <div className="flex flex-col justify-center gap-1">
                <div className="flex items-center text-secondary gap-1 md:justify-center lg:justify-start">
                  {[1, 2, 3, 4, 5].map((i) => <Star key={i} className="w-5 h-5 md:w-9 md:h-9 fill-current" />)}
                </div>
                <p className="text-sm md:text-2xl font-medium text-gray-300 whitespace-nowrap">Trusted by 10k+ users</p>
              </div>
            </div>
          </motion.div>
