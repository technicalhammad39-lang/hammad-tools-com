    ...
    <div className="min-h-screen pt-32 pb-20 px-4 bg-brand-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <button onClick={() => router.back()} className="group inline-flex items-center space-x-3 text-brand-text/40 hover:text-primary mb-12 transition-all p-2 rounded-xl hover:bg-white/5">
          ...
          <span className="uppercase font-black tracking-[0.2em] text-[10px]">Back to Intelligence</span>
        </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <motion.div
              ...
              className="relative aspect-square rounded-[3.5rem] overflow-hidden border border-white/10 shadow-3xl group"
            >
              <Image 
                src={service.image} 
                alt={service.name} 
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="glass p-6 rounded-[2rem] border border-white/5 flex items-center gap-4 group">
                  ...
                  <div>
                    <div className="text-[9px] font-black uppercase tracking-widest text-brand-text/30">Delivery</div>
                    <div className="text-xs font-black uppercase text-emerald-400">{service.deliveryStatus || 'Instant after payment'}</div>
                  </div>
               </div>
               <div className="glass p-6 rounded-[2rem] border border-white/5 flex items-center gap-4 group">
                  ...
                  <div>
                    <div className="text-[9px] font-black uppercase tracking-widest text-brand-text/30">Access Type</div>
                    <div className="text-xs font-black uppercase text-secondary">{service.accessType || 'Shared Access'}</div>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="space-y-6">
               <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-xl font-black uppercase tracking-tighter text-brand-text">Choose your evolution</h3>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {(service.plans && service.plans.length > 0 ? service.plans : [
                    ...
                    <button
                      ...
                      className={`relative p-8 rounded-[2.5rem] border text-left transition-all group ${
               ...
               <div className="space-y-4">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className={`w-full bg-white/5 border rounded-2xl px-12 py-5 text-sm font-black tracking-widest focus:outline-none transition-all ${
                        couponStatus === 'valid' ? 'border-emerald-500/50 text-emerald-400' : 
