            ...
            {activeTab === 'orders' && (
              <motion.div key="orders" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                ...
                <div className="glass rounded-2xl border border-white/5 overflow-hidden">
                  <div className="px-4 py-3 border-b border-white/5 text-[10px] font-black uppercase tracking-widest text-brand-text/40">
                    Select Order
                  </div>
                  <div className="p-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                    {orders.length === 0 ? (
                      <div className="md:col-span-2 xl:col-span-3 p-8 text-center text-[10px] font-black uppercase tracking-widest text-brand-text/30 border border-white/5 rounded-xl">
                        No orders found.
                      </div>
                    ) : (
                      orders.map((order) => (
                        <button
                          ...
                          className={`text-left rounded-xl border px-4 py-3 space-y-2 transition-colors ${
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div
                              className={`px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-widest border ${statusClass(
                                order.status
                              )}`}
                            >
                              {formatOrderStatusLabel(order.status)}
                ...
                <div className="glass rounded-2xl border border-white/5 p-4 md:p-5 space-y-4">
                  {!selectedOrder ? (
                    ...
                    <>
                      ...
                      <div className="rounded-xl border border-white/10 bg-white/[0.02] px-4 py-3 text-sm text-brand-text/60">
                        For conversation with admin, open the <span className="text-primary font-semibold">Order Messages</span> tab.
                      </div>
                    </>
                  )}
                </div>
